...
profile_base() {
	...
	apks="busybox musl alpine-base pipexec alpine-mirrors busybox kbd-bkeymaps openntpd ethtool hwdata lsof lm_sensors e2fsprogs network-extras libressl openssh tzdata"
	apkovl=
	hostname="cryptos"
}
